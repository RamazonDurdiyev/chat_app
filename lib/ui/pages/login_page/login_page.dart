    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          _buildTextField("Cyber account", loginBloc.emailCtrl),
          const SizedBox(
            height: 4,
          ),
      ...
      child: AnimatedTextKit(
        ...
        animatedTexts: [
          TyperAnimatedText(
            ...
            "Welcome to Cyber league, if you are registered continue with your cyber account else register and join our team.",
